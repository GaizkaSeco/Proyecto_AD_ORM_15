...
CREATE TABLE `proyectos` (
  `codproye` varchar(6) NOT NULL,
  `nombre` varchar(40) NOT NULL,
  `ciudad` varchar(40) DEFAULT NULL,
  `estado` varchar(4) NOT NULL,
  PRIMARY KEY (`codproye`)
...
INSERT INTO `proyectos` VALUES ('PR1234','Proyecto 1','Vitoria','alta'),('PR5678','Proyecto 2','Vitoria','alta'),('PR8888','Proyecto 4','Vitoria','alta'),('PR9988','Proyecto 3','Vitoria','alta');
